 ...
 * </pre>
 */
public class PositiveContinuousTokenizer extends Tokenizer {
	...
	public PositiveContinuousTokenizer(Reader in) {
		super(in);
	}
	...
	public boolean incrementToken() throws IOException {
		...
		this.termAtt.copyBuffer(this.ioBuffer, 0, ++this.indexLength);
		this.offsetAtt.setOffset(correctOffset(0), correctOffset(this.indexLength));
		return true;
	}
