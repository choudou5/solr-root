...
<!--main-content-part-->
<div id="content">
<sys:breadcrumbs currLevel="2" secondLevelTitle="应用列表" secondLevelView="/console/collection/schema/list"/>
		                  ...
		                  <td class="center">
		                  	<c:if test="${schema.isSys && fns:isAdmin(sid)}">
		                  		<c:if test="${schema.ext.isRun }">
		                    		<a href="${ctx }/console/collection/data/list?schemaName=${schema.name }">数据管理</a>&nbsp;&nbsp;
