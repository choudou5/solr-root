(function(b) { b.gritter = { 
    ...
    var a = { position: "",
        ...
        add: function(g) { 
            ...
            j = g.position || b.gritter.options.position,
            d = g.time || "";
            this._verifyWrapper();
            this._item_count++;
            ...
            if (k) { k = this._str_replace("[[title]]", k, this._tpl_title) 
            } else { k = "" 
            }
            ...
            function() { a["_after_open_" + f](b(this)) 
            });
            ...
            function(p) { 
                if (p.type == "mouseenter") { 
                    if (!l) { a._restoreItemIfFading(b(this), f) 
                    } 
                } else { 
            ...
            b(o).find(".gritter-close").click(function() { a.removeSpecific(f, { 
                },
                null, true) 
            });
            return f 
        },
        _countRemoveWrapper: function(c, d, f) { d.remove();
        ...
        _fade: function(g, d, j, f) { 
            ...
            if (i) { g.animate({ opacity: 0 
                },
                c,
                function() { g.animate({ height: 0 
                    },
                    300,
                    function() { a._countRemoveWrapper(d, g, h) 
                    }) 
                }) 
            } else { this._countRemoveWrapper(d, g) 
            } 
        },
        ...
        _restoreItemIfFading: function(d, c) { clearTimeout(this["_int_id_" + c]);
            d.stop().css({ opacity: "",
                height: "" 
            }) 
        },
        ...
        _setFadeTimer: function(f, d) { 
            ...
            this["_int_id_" + d] = setTimeout(function() { a._fade(f, d) 
            },
            c) 
        },
        stop: function(e) { 
