package com.choudoufu.client.service;
 ...
 * </pre>
 */
public abstract interface SolrService {
	   ...
	   * @since  1.0.0
	   */
	  public <T extends SolrBaseModel> T findById(String moduleName, String id, Class<T> objectClass);
	   ...
	   * @since  1.0.0
	   */
	  public <T extends SolrBaseModel> List<T> findByIds(String moduleName, List<String> ids, Class<T> objectClass);
	 ...
	 /**
	   ...
	   * @since  1.0.0
	   */
	  public <T extends SolrBaseModel> void addObjectByAsync(String moduleName, T obj);
	   ...
	   * @since  1.0.0
	   */
	  public <T extends SolrBaseModel> void addListByAsync(String moduleName, List<T> list);
